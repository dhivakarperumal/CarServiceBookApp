        ...
        <View className="gap-6">
          <Section>
              ...
              <View className="flex-row items-center gap-4 flex-1">
                ...
                <View>
                  ...
                  <Text className="text-text-secondary text-[8px] font-black uppercase tracking-widest mt-1">
                    Manage Customers & Platform Accounts
                  </Text>
                </View>
              </View>
            ...
            <TouchableOpacity
              ...
              className="flex-row items-center justify-between p-5 bg-card border border-slate-700 rounded-3xl mt-4 shadow-2xl"
            >
              <View className="flex-row items-center gap-4 flex-1">
                <View className="w-12 h-12 bg-card rounded-2xl items-center justify-center border border-slate-700 shadow-lg shadow-primary/10">
                  <Ionicons
            ...
            <TouchableOpacity
              onPress={() =>
                router.push("/(adminPages)/product-billing" as any)
              }
              className="flex-row items-center justify-between p-5 bg-card border border-slate-700 rounded-3xl mt-4 shadow-2xl"
            >
              <View className="flex-row items-center gap-4 flex-1">
