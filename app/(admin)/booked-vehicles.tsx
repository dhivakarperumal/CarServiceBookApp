        ...
        <View className="px-2 py-6">
          ...
          <View className="pb-20">
            {filteredBookings.length === 0 ? (
              <View className="py-20 items-center bg-card rounded-[40px] border border-dashed border-slate-700 mx-2">
              ...
              filteredBookings.map((b, i) => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    className="bg-card border border-slate-700 rounded-3xl p-5 mb-4 mx-2"
                  >
