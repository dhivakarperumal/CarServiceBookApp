...
export default function OrderDetails() {
  ...
  const currentStepIdx = TRACK_STEPS.findIndex(
    (s) => s.id === normalizeKey(order.status),
  );
      ...
      >
                    ...
                    <View style={{ alignItems: "center", gap: 6 }}>
                      <View
                        style={{
                          ...
                          justifyContent: "center",
                          borderWidth: 2,
                          borderColor: done ? COLORS.primary : COLORS.slate700,
                        }}
                      >
                        <Ionicons
        ...
        <Card>
          ...
          <InfoRow
            ...
            label="Name"
            value={order.shippingName || order.customerName}
          />
          <InfoRow
