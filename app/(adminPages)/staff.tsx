        ...
        <View className="flex-row flex-wrap justify-between">
          {filtered.length === 0 ? (
            <View className="w-full p-20 items-center justify-center opacity-30">
              ...
              <Text className="text-white font-black text-xs uppercase mt-4">
                Empty Roster
              </Text>
            </View>
          ) : (
            filtered.map((s, i) => (
              ...
              >
                ...
                <TouchableOpacity className="bg-white/5 p-2 rounded-xl items-center">
                  <Text className="text-slate-400 font-black text-[8px] uppercase">
                    Permission →
                  </Text>
                </TouchableOpacity>
              </View>
